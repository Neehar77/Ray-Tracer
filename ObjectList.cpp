...
const int ObjectList::diffuse(Vec3 normal, Vec3 light_to_point)
{
    return dot(normal, light_to_point);
}

const int ObjectList::specular(Vec3 normal, Vec3 light_to_point)
{
    return 0;
}
